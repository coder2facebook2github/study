...
public class RequestMatcher {
    private static final Log logger = LogFactory.getLog(RequestMatcher.class);
    private static final String MATCH_ALL = "/**";
    private final RequestMatcher.Matcher matcher;
    ...
    public RequestMatcher(String pattern, String httpMethod, boolean caseSensitive) {
        ...
        if (!pattern.equals("/**") && !pattern.equals("**")) {
            if (pattern.endsWith("/**") && pattern.indexOf(63) == -1 && pattern.indexOf(123) == -1 && pattern.indexOf(125) == -1 && pattern.indexOf("*") == pattern.length() - 2) {
                this.matcher = new RequestMatcher.SubpathMatcher(pattern.substring(0, pattern.length() - 3), caseSensitive);
            } else {
                this.matcher = new RequestMatcher.SpringAntMatcher(pattern, caseSensitive);
            }
        } else {
            pattern = "/**";
            this.matcher = null;
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof RequestMatcher)) {
            ...
            RequestMatcher other = (RequestMatcher) obj;
    ...
    private static class SubpathMatcher implements RequestMatcher.Matcher {
    ...
    private static class SpringAntMatcher implements RequestMatcher.Matcher {
