...
//        PageService<WareHouseSku> pageService = new PageServiceImpl<WareHouseSku>() ;
//        System.out.print(getSuperClassGenricType(ClassUtils.getUserClass(ABService.class), 0));
    }
    /**
    ...
    /**
     * 通过反射,tguyhklikklk. 如BuyerServiceBean extends DaoSupport<Buyer>
     *
